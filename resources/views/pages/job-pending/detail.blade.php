...
@section('title')
    Detail Pending Job {{ $jobDivisi->kode }}
@endsection
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary btn__buka_pendingan">Buka Pendingan</button>
                    </div>
                </div>
            </div>
        </div>
        {{-- modal buka pendingan end --}}
    @endif
@endsection
...
@push('addScript')
    <script>
        ...
        $(".btn__buka_pendingan").on("click", function() {
            $(".loading__global").show();
