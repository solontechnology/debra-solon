    ...
    <main>
        <div class="kop">
            ...
            <div class="" style="font-size: 12px;">
                ...
                HP : 0877 7523 2059 - 08778 8030 3539 <br>
                Email : notarisdebra2568@gmail.com <br>
                <h1>FAKTUR PENAGIHAN - UMUM</h1>
            </div>
        </div>
        ...
        <div class="list_tagihan" style="font-size: 10px;">
            ...
            <table>
                ...
                <tr style="font-size: 10px;">
                    ...
                    <td style="border-top: 1px solid #000; padding-top: 10px;">Rp.</td>
                    <td style="border-top: 1px solid #000; text-align: right; padding-right: 10px; padding-top: 10px;">
        ...
        <footer>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        <p style="font-size: 12px;">DEBRA T.C. SCHRAM S.H.</p>
                    </td>
