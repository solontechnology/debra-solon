...
<form id="filterForm" action="{{ route('laporan.detail-pekerjaan-job-divisi', $encryptedId) }}" method="GET" style="display: flex; align-items: center; gap: 10px;">
    <label>Dari:</label>
...
<a href="{{ route('laporan.detail-pekerjaan-job-divisi', [$encryptedId, 'sort' => 'default']) }}" class="btn btn-primary">Reset</a>


<a href="{{ route('laporan.detail-pekerjaan-job-divisi.export', $encryptedId) }}" class="btn btn-success">
