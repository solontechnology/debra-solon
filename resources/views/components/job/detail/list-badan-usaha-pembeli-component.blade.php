<div class="mb-5">
    @if (count($listBadanUsahaPembeli) > 0)
        <!-- Header Section -->
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="fw-bold text-dark mb-0">
                <i class="bi bi-shop text-primary me-2"></i>Daftar Badan Usaha Pembeli Terdaftar
            </h6>
        </div>

        <!-- Card Table Modern Badan Usaha Pembeli -->
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 text-nowrap">
                    ...
                    <tbody class="border-top-0">
                        @foreach ($listBadanUsahaPembeli as $item)
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-inline-flex gap-1">
                                        @can('data-pendukung/badan-usaha-pembeli/edit')
                                            <a href="{{ route('job.divisi-data-pendukung-badan-usaha-pembeli.edit', $item->id) }}"
                                                class="btn btn-sm btn-outline-secondary border-0 rounded-circle p-2"
                                                title="Edit Badan Usaha Pembeli">
                                        ...
                                        @endcan
                                        @can('data-pendukung/badan-usaha-pembeli/delete')
                                            <form
                                                action="{{ route('job.divisi-data-pendukung-badan-usaha-pembeli.delete', $item->id) }}"
                                                method="POST" class="confirm_delete d-inline"
                                                data-message="badan usaha pembeli {{ $item->nama_badan_usaha }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-sm btn-outline-danger border-0 rounded-circle p-2"
                                                    title="Hapus Badan Usaha Pembeli">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        fill="currentColor" viewBox="0 0 16 16">
                                                        <path
            ...
            <div class="py-3">
                <div class="bg-primary bg-opacity-10 text-primary rounded-circle d-inline-flex p-3 mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                        ...
                        <path
                            d="M2.97 1.35A1 1 0 0 1 3.73 1h8.54a1 1 0 0 1 .76.35l2.609 3.044A1.5 1.5 0 0 1 16 5.37v.255a2.375 2.375 0 0 1-4.25 1.458A2.371 2.371 0 0 1 9.875 8 2.37 2.37 0 0 1 8 7.083 2.37 2.37 0 0 1 6.125 8a2.37 2.37 0 0 1-1.875-.917A2.375 2.375 0 0 1 0 5.625V5.37a1.5 1.5 0 0 1 .361-.976l2.61-3.045zm1.78 4.275a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0 1.375 1.375 0 1 0 2.75 0V5.37a.5.5 0 0 0-.12-.325L12.27 2H3.73L1.12 5.045A.5.5 0 0 0 1 5.37v.255a1.375 1.375 0 0 0 2.75 0 .5.5 0 0 1 1 0zM1.5 6.987V15h13V6.987a6.5 6.5 0 0 1-13 0z" />
                    </svg>
                </div>
                <h6 class="fw-bold text-dark">Belum Ada Data Badan Usaha Pembeli</h6>
                <p class="text-muted small mb-0">Silakan gunakan form untuk menambahkan data badan usaha pembeli.</p>
            </div>
        </div>
    @endif
</div>
