  ...
  @section('title', 'SUPER NOTARIS')
  {{-- @push('addStyle')
      <link rel="stylesheet" href="{{ asset('tabler-admin/demo/dist/css/tabler.min.css') }}">
  @endpush --}}
          ...
          <div class="card">
              <div class="card-body">
                  <div class="d-flex">
                      ...
                      <div class="ms-auto">
                          <div class="dropdown">
                              <a class="dropdown-toggle text-secondary" id="social-referrals-dropdown" href="#"
                  ...
                  <table class="table table-vcenter">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td class="td-truncate">
                                  <div class="text-truncate">Change deprecated html tags to text decoration classes
                                      (#29604)</div>
                              </td>
                          ...
                          <tr>
                              ...
                              <td class="td-truncate">
                                  <div class="text-truncate">justify-content:between ⇒ justify-content:space-between
                                      (#29734)</div>
                              </td>
  ...
  @push('addScript')
      {{-- <script src="{{asset('tabler-admin/demo/dist/libs/apexcharts/dist/locales/tr.json')}}"></script> --}}
      {{-- <script src="{{ asset('tabler-admin/demo/dist/js/tabler.js') }}"></script> --}}
      {{-- <script src="{{asset('tabler-admin/demo/dist/js/tabler.min.js')}}"></script> --}}
              ...
              window.ApexCharts &&
                  new ApexCharts(document.getElementById("chart-social-referrals"), {
                      ...
                      series: [{
                              name: "Facebook",
                              data: [
                                  13281, 8521, 15038, 9983, 15417, 8888, 7052, 14270, 5214, 9587, 5950,
                                  16852, 17836, 12217, 17406, 12262, 9147, 14961, 18292, 15230, 13435,
                                  10649, 5140, 13680, 4508, 13271, 13413, 5543, 18727, 18238, 18175, 6246,
                                  5864, 17847, 9170, 6445, 12945, 8142, 8980, 10422, 15535, 11569,
                                  10114, 17621, 16138, 13046, 6652, 9906, 14100, 16495, 6749,
                              ],
                          },
                          {
                              name: "Twitter",
                              data: [
                                  3680, 1862, 3070, 2252, 5348, 3091, 3000, 3984, 5176, 5325, 2420, 5474,
                                  3098, 1893, 3748, 2879, 4197, 5186, 4213, 4334, 2807, 1594, 4863,
                                  2030, 3752, 4856, 5341, 3954, 3461, 3097, 3404, 4949, 2283, 3227, 3630,
                                  2360, 3477, 4675, 1901, 2252, 3347, 2954, 5029, 2079, 2830, 3292,
                                  4578, 3401, 4104, 3749, 4457, 3734,
                              ],
                          },
                          {
                              name: "Dribbble",
                              data: [
                                  722, 1866, 961, 1108, 1110, 561, 1753, 1815, 1985, 776, 859, 547, 1488,
                                  766, 702, 621, 1599, 1372, 1620, 963, 759, 764, 739, 789, 1696, 1454,
                                  1842, 734, 551, 1689, 1924, 1875, 908, 1675, 1541, 1953, 534, 502, 1524,
                                  1867, 719, 1472, 1608, 1025, 889, 1150, 654, 1695, 1662, 1285, 1787,
                              ],
                          },
                          {
                              name: "IG",
                              data: [
                                  859, 547, 1488, 766, 702, 621, 1599, 1372, 1620, 963,
                                  722, 1866, 961, 1108, 1110, 561, 1753, 1815, 1985, 776,
                                  759, 764, 739, 789, 1696, 1454, 1842, 734, 551, 1689,
                                  1924, 1875, 908, 1675, 1541, 1953, 534, 502, 1524, 1867,
                                  719, 1472, 1608, 1025, 889, 1150, 654, 1695, 1662, 1285,
                                  1787
                              ],
                          },
                      ],
                      ...
                      colors: [
                          "color-mix(in srgb, transparent, var(--tblr-facebook) 100%)",
                          "color-mix(in srgb, transparent, var(--tblr-twitter) 100%)",
                          "color-mix(in srgb, transparent, var(--tblr-dribbble) 100%)",
                          "color-mix(in srgb, transparent, var(--tblr-dribbble) 100%)",
                      ],
                      legend: {
                          show: true,
          ...
          document.addEventListener("DOMContentLoaded", function() {
              window.ApexCharts &&
                  new ApexCharts(document.getElementById("chart-completion-tasks"), {
                      ...
                      labels: ["2020-06-21", "2020-06-22", "2020-06-23", "2020-06-24", "2020-06-25", "2020-06-26",
                          "2020-06-27"
                      ],
      ...
      <script>
          document.addEventListener("DOMContentLoaded", function() {
              window.ApexCharts &&
                  new ApexCharts(document.getElementById("chart-completion-tasks-2"), {
                      chart: {
                          type: "line",
                          fontFamily: "inherit",
                          height: 240,
          ...
          document.addEventListener("DOMContentLoaded", function() {
              window.ApexCharts &&
                  new ApexCharts(document.getElementById("chart-development-activity"), {
                      ...
                      series: [{
                          name: "Purchases",
                          data: [3, 5, 4, 6, 17, 5, 6, 8, 24, 17, 12, 5, 6, 32, 18, 24, 14, 30, 17, 19, 15, 14,
